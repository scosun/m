...
(function(){
	...
	seatMapsControl.prototype.dragContainerMove = function(){
		//获取推拽框位置
		// var container = $("#dragcontainerId");
		var container = $("#seatcontainerId");
	...
	seatMapsControl.prototype.dragPadContainerMove = function(cx,cy,startSeledPos,seledIds){
		//获取推拽框位置
		// var container = $("#dragcontainerId");
		...
		// var seled = container.find(".seled");
		// // console.log("seled------",seled)
		for(var n = 0,len = startSeledPos.length; n < len; n++){
			var x = parseInt(startSeledPos[n][0]);
			var y = parseInt(startSeledPos[n][1]);
	...
	seatMapsControl.prototype.exChangeOnlySeats = function(ids){
	...
	seatMapsControl.prototype.dragMatchSeat = function(_x,_y){
		//鼠标位置
		// var _x = window.event.x
		// var _y = window.event.y
